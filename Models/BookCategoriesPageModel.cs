...
namespace Lazar_Andreea_Lab8.Models
{
    public class BookCategoriesPageModel:PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Lazar_Andreea_Lab8Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Lazar_Andreea_Lab8Context context,
